  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-gray-200">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Image Upscaler & Resizer</h2>
          <p className="text-gray-500 text-sm mt-1">Enhance image resolution locally using high-quality resampling.</p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <label className="text-sm font-medium text-gray-700">Select Scale Factor</label>
              ...
              {[2, 4, 8].map((s) => (
                <button
                  ...
                  className={`flex-1 py-2 px-4 rounded-lg font-medium transition-colors ${
                    scale === s ? 'bg-blue-100 text-blue-700 border-2 border-blue-500' : 'bg-gray-50 text-gray-600 border-2 border-transparent hover:bg-gray-100'
                  }`}
                >
                  {s}x
                </button>
        ...
        <div className="flex flex-col h-full min-h-[400px]">
          <div className="flex items-center justify-between mb-2">
            <label className="text-sm font-medium text-gray-700">Upscaled Result</label>
            {outputImage && (
              <button
          ...
          <div className="flex-1 bg-gray-50 rounded-xl border border-gray-200 flex items-center justify-center overflow-hidden p-4">
            {outputImage ? (
              <img src={outputImage} alt="Upscaled" className="max-h-full max-w-full object-contain rounded-lg shadow-sm" />
            ) : (
              <p className="text-gray-400 text-center">Processed image will appear here</p>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="mt-12 bg-white p-8 rounded-xl shadow-sm border border-gray-200 text-gray-600 leading-relaxed">
        <h2 className="text-xl font-bold text-gray-900 mb-4 text-center">AI Image Upscaler: Enhance Resolution Online Free</h2>
        
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-md font-semibold text-gray-800 mb-2">Upscale Image Free Without Quality Loss</h3>
            <p className="text-sm mb-4">
              Looking for a way to <strong className="text-gray-800">upscale image free</strong>? Our <strong className="text-gray-800">AI image upscaler</strong> uses advanced resampling algorithms to <strong className="text-gray-800">enhance image resolution online</strong> instantly. Whether you need to <strong className="text-gray-800">increase image size without losing quality</strong> or fix blurry photos, our tool provides professional-grade results. It's the perfect <strong className="text-gray-800">image enlarger online</strong> for your low-res pictures.
            </p>
          </div>
          <div>
            <h3 className="text-md font-semibold text-gray-800 mb-2">Secure & Private Photo Enhancer AI</h3>
            <p className="text-sm mb-4">
              Our <strong className="text-gray-800">photo enhancer AI</strong> runs entirely in your browser, ensuring your images are never uploaded to any server. This makes it a <strong className="text-gray-800">secure image upscaler</strong> for personal and professional use. From creating a <strong className="text-gray-800">4k image upscaler</strong> result to simply enlarging a small icon, BitBrainTech handles it all locally with maximum speed and privacy.
            </p>
          </div>
        </div>

        <div className="mt-6 pt-6 border-t border-gray-100">
          <h3 className="text-md font-semibold text-gray-800 mb-2">Why Use Our Free Image Upscaler?</h3>
          <p className="text-sm">
            BitBrainTech provides a powerful <strong className="text-gray-800">free image upscaler</strong> that is fast, reliable, and easy to use. It's a great <strong className="text-gray-800">waifu2x online alternative</strong> for upscaling anime art, photos, and graphics. With our <strong className="text-gray-800">high-quality image upscaler</strong>, you can transform your low-resolution images into crisp, clear visuals ready for print or high-res displays.
          </p>
        </div>
      </div>
    </div>
